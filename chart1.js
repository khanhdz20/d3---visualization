...
d3.csv("data.csv").then(data => {
    ...
    // Danh sách màu theo nhóm hàng từ hình ảnh
    const colorMapping = {
        "[BOT] Bột": "#4361ee",
        "[SET] Set trà": "#f4a261",
        "[THO] Trà hoa": "#e63946",
        "[TMX] Trà mix": "#8ecae6",
        "[TTC] Trà củ, quả sấy": "#2a9d8f"
    };

    // Kích thước SVG
    const width = 1400;
    const height = 700;
    const margin = { top: 50, right: 250, bottom: 80, left: 280 };
    ...
    // Thêm chú thích màu sắc (Legend) bên ngoài biểu đồ
